...
#include "src/commom/dynamicwidget.h"
...
void DynamicWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DynamicWidget *_t = static_cast<DynamicWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DynamicWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DynamicWidget.data,
      qt_meta_data_DynamicWidget,  qt_static_metacall, nullptr, nullptr}
};
