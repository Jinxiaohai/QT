/****************************************************************************
** Meta object code from reading C++ file 'widgetaction.h'
**
...
#error "The header file 'widgetaction.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 7), // "getText"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 6), // "string"
QT_MOC_LITERAL(4, 29, 8) // "sendText"

    },
    "WidgetAction\0getText\0\0string\0sendText"
};
...
void WidgetAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WidgetAction *_t = static_cast<WidgetAction *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (WidgetAction::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WidgetAction::getText)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WidgetAction::staticMetaObject = {
    { &QWidgetAction::staticMetaObject, qt_meta_stringdata_WidgetAction.data,
      qt_meta_data_WidgetAction,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void WidgetAction::getText(const QString & _t1)
{
