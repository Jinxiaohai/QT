...
void Spreadsheet::clear() {
  setRowCount(0);
  setColumnCount(0);
  setRowCount(RowCount);       /*!< (0-999) */
  setColumnCount(ColumnCount); /*!< (A-Z) */
...
bool Spreadsheet::sort(const SpreadsheetCompare &compare) {
...
void Spreadsheet::selectCurrentRow() { selectRow(currentRow()); }

void Spreadsheet::selectCurrentColumn() { selectColumn(currentColumn()); }
...
bool SpreadsheetCompare::operator()(const QString &row1,
