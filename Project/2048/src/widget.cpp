...
void Widget::resizeEvent(QResizeEvent *) {
  ...
  restartBtn->setStyleSheet(
      QString(BTNSTYLESHEET).arg(3 * ratioW).arg(15 * ratioW));
  highScoreLbl->setStyleSheet(
      QString(LBLSTYLESHEET).arg(5 * ratioW).arg(20 * ratioW));
  scoreLbl->setStyleSheet(
      QString(LBLSTYLESHEET).arg(5 * ratioW).arg(20 * ratioW));
  gameWidget->setGeometry(2 * ratioW, 200 * ratioH, 400 * ratioW, 400 * ratioH);
  restartBtn->setGeometry(100 * ratioW, 120 * ratioH, 200 * ratioW,
                          50 * ratioH);
  highScoreLbl->setGeometry(209 * ratioW, 20 * ratioH, 180 * ratioW,
                            70 * ratioH);
